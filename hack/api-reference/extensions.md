...
<td>
<em>(Optional)</em>
<p>Region is the region of this DNS record. If not specified, a certain default region will be used,
e.g. us-west-2 for AWS route53.</p>
</td>
</tr>
<tr>
<td>
...
<td>
<em>(Optional)</em>
<p>RecordType is the DNS record type. Only A and TXT records are currently supported. Defaults to A.</p>
</td>
</tr>
<tr>
<td>
