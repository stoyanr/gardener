...
type DNSRecordSpec struct {
	...
	// Region is the region of this DNS record.
...
const (
	// DNSRecordPurposeExternal specifies that the DNSRecord is of type A for external access.
	DNSRecordPurposeExternal DNSRecordPurpose = "external"
	// DNSRecordPurposeInternal specifies that the DNSRecord is of type A for internal access.
	DNSRecordPurposeInternal DNSRecordPurpose = "internal"
	// DNSRecordPurposeOwner specifies that the DNSRecord is of type TXT and contains information about the current owner of the shoot.
	DNSRecordPurposeOwner DNSRecordPurpose = "owner"
)
