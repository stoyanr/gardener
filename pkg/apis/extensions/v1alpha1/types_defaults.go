...
type DefaultSpec struct {
	...
	// +optional
	Resources []gardencorev1alpha1.NamedResourceReference `json:"resources,omitempty" protobuf:"bytes,15,rep,name=resources"`
}
...
func (d *DefaultSpec) GetResources() []gardencorev1alpha1.NamedResourceReference {
	return d.Resources
}
