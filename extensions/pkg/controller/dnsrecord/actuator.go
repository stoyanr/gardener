...
type Actuator interface {
	...
	Reconcile(context.Context, *extensionsv1alpha1.DNSRecord, *extensionscontroller.Cluster) (bool, error)
	...
	Restore(context.Context, *extensionsv1alpha1.DNSRecord, *extensionscontroller.Cluster) (bool, error)
